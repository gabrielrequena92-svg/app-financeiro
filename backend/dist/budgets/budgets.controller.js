...
let BudgetsController = class BudgetsController {
    ...
    create(contextId, createBudgetDto) {
        return this.budgetsService.create(contextId, createBudgetDto);
    }
    findAll(contextId, month, year) {
        return this.budgetsService.findAll(contextId, month ? +month : undefined, year ? +year : undefined);
    }
    findOne(id) {
...
__decorate([
    (0, common_1.Post)(),
    __param(0, (0, common_1.Param)('contextId', common_1.ParseUUIDPipe)),
...
exports.BudgetsController = BudgetsController = __decorate([
    (0, common_1.Controller)('contexts/:contextId/budgets'),
